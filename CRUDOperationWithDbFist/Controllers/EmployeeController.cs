...
namespace CRUDOperationWithDbFist.Controllers
{
    ...
    public class EmployeeController : ApiController
    {
        ...
        [HttpGet]
        public HttpResponseMessage GetAllEmployeeWithQueryString([FromUri] string gender = "all", [FromUri] int? top = 0)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (db.SaveChanges() > 0)
                        ...
                        return Request.CreateErrorResponse(HttpStatusCode.ServiceUnavailable, "Data could not be updated.");
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (db.SaveChanges() > 0)
                        ...
                        return Request.CreateErrorResponse(HttpStatusCode.ServiceUnavailable, "Data could not be deleted.");
                }
            }
            catch (Exception ex)
            {
